...
export class WorkoutService extends ServiceBase {
  ...
  public static clone(workout: WorkoutModel): WorkoutModel {
    ...
    return new WorkoutModel(workout.title, category, workout.notes, workout.burnrate, false,
      workout.startdate, workout.starttime, workout.enddate, workout.endtime, workout.comment, 
      workout.status, workout.id);
  }
  ...
  public create(workout: WorkoutModel) {
  ...
  public search(start: Date, end: Date) {
  ...
  public update(workout: WorkoutModel) {
